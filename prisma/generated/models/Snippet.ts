...
export type SnippetWhereInput = {
  ...
  difficulty?: Prisma.StringNullableFilter<"Snippet"> | string | null
}
...
export type SnippetScalarWhereWithAggregatesInput = {
  ...
  difficulty?: Prisma.StringNullableWithAggregatesFilter<"Snippet"> | string | null
}
...
export type SnippetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "language" | "code" | "difficulty", ExtArgs["result"]["snippet"]>
...
export interface SnippetFieldRefs {
  ...
  readonly difficulty: Prisma.FieldRef<"Snippet", 'String'>
}
