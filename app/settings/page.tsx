        ...
        try {
            ...
            if (res.ok) {
                ...
                setForm({
                    ...
                    defaultSessionMinutes: p.default_session_minutes ?? 30
                })
            }
        } catch (e) {
            console.error(e)
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-6 py-8">
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2">Default session length (minutes)</label>
                            <input
                                type="number"
                                min={5}
                                max={120}
                                ...
                                onChange={e => setForm(f => ({ ...f, defaultSessionMinutes: Number(e.target.value) || 30 }))}
                                className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-slate-700 focus:border-primary outline-none"
                            />
                        </div>
                        <button
