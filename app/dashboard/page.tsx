    ...
    const getRecommendation = async () => {
        ...
        try {
            const response = await fetch('/api/recommend', {
                ...
                body: JSON.stringify({ mood, timeAvailable })
            })
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <StatCard
                        ...
                        value={`${Math.floor((stats?.total_study_time || 0) / 60)}h`}
                        color="blue"
                    />
                    <StatCard
                                ...
                                <div className="grid grid-cols-3 gap-4 mb-6">
                                    {moods.map((m) => (
                                        <button
                                            ...
                                            className={`p-6 rounded-xl border-2 transition-all ${mood === m.value
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <p className="text-sm text-slate-300">
                                Study in focused blocks and take short breaks. Your brain retains information better with spaced repetition!
                            </p>
                        </motion.div>
                    </div>
                </div>
